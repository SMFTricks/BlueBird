	...
	<div class="tborder childboards" id="board_', $context['current_board'], '_childboards">
		...
		<div class="boardindex_table">
			<table class="table_list tb-boards">
				<tbody id="board_', $context['current_board'], '_children_titles">
					<tr class="boards-titles">
						<td>', $txt['sh_status'], '</td>
						<td>', $txt['board'], '</td>
						<td align="center">', $txt['posts'], '</td>
						<td>', $txt['last_post'], '</td>
					</tr>
				</tbody>
		...
		{
			echo '
				<tr id="board_', $board['id'], '" class="windowbg lgf_boards">
					<td class="icon">
			...
			if (!empty($board['children']))
			{
				...
				echo '
				<tr id="board_', $board['id'], '_children"><td colspan="4" class="children windowbg3 td-children"><strong>', $txt['parent_boards'], '</strong>: ', implode(', ', $children), '</td></tr>';
			}
		}
		echo '
				</tbody>
